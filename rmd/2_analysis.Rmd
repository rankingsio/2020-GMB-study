...
```{r results=FALSE, message=FALSE, echo=FALSE}
  ...
  required_packages <- c("xgboost", "data.table", "stringr", "SHAPforxgboost", "ggplot2", "gridExtra", "wordcloud", "tm", "grDevices")
...
ref_domains_dofollow_table <- rbindlist(rs)
setnames(ref_domains_dofollow_table, 1:4, c("Type", "ref_domains_dofollow", "total_traffic", "ahrefs_rank"))

knitr::kable(ref_domains_dofollow_table, caption = "Basic information about ref_domains_dofollow and total_traffic")
