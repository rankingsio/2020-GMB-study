...
plotly <- function(p, pos, w, h) {
  ggplotly(p, width = w, height = h) %>%
  config(displayModeBar = FALSE) %>%    
  layout(
    margin = list(l = 50, r = 50, t = 100, b = pos*700),
    annotations =
    list(x = 1, y = -pos, text = caption,
         showarrow = F, xref = 'paper', yref = 'paper',
         xanchor = 'right', yanchor = 'auto', xshift = 0, yshift = 0,
         font = list(size = 14, family = "Lora"))
 )
}
```
...
if(save == T){ 
  ...
  # interactive chart pushed to plotly chart studio
  g <- plotly(feature_importance_plot, .15, w = 1000, h = 900)
...
if(save == T){ 
  ...
  # interactive chart pushed to plotly chart studio
  g <- plotly(type_freq_plot, .15, w = 1500, h = 900)
  api_create(g, filename = "type_freq_plot")
  g <- plotly(type_position_plotly, .1, w = 1250, h = 800)
  api_create(g, filename = "type_position_plot")
  g <- plotly(type_position_plotly_scaled, .1, w = 1250, h = 800)
...
description_car_personal_plot <-
  ...
  scale_x_continuous(breaks = c(1, 5, 10, 15, 20), expand = c(.02, .02)) +
  scale_y_continuous(expand = c(0,0))  +
  labs(x = NULL, y = "Count", title = title_d, caption = caption) +
  facet_wrap(~cat)
...
title_car_personal_plot <-
  ...
  ylab("Count") +
  xlab("Position") + 
  labs(x = NULL, y = "Count", title = title_t, cpation = caption) +
  facet_wrap(~cat)
...
title_lawyer_attorney_plot <-
  ...
  scale_x_continuous(breaks = c(1, 5, 10, 15, 20), expand = c(.02, .02)) +
  scale_y_continuous(expand = c(0,0))  +
  labs(x = NULL, y = "Count", title = title_t, caption = caption) +
  facet_wrap(~cat)
...
description_city_plot <-
  ...
  scale_x_continuous(breaks = c(1, 5, 10, 15, 20), expand = c(.02, .02)) +
  scale_y_continuous(expand = c(0,0)) +
  labs(x = NULL, y = "Count", title = "Including the city name in GMB profile description helps to increase position", caption = caption) +
  theme() +
  facet_wrap(~cat)
...
title_city_plot <-
  ...
  scale_x_continuous(breaks = c(1, 5, 10, 15, 20), expand = c(.02, .02)) +
  scale_y_continuous(expand = c(0,0))  +
  labs(x = NULL, y = "Count", title = "Including the city name in GMB profile title helps to increase position", caption = caption) +
  facet_wrap(~cat)
...
if(save == T){ 
  ...
  # interactive chart pushed to plotly chart studio
  g <- plotly(plot_count_title + ggtitle("Non-empty title length boxplots"), .15, w = 900, h = 700)
  api_create(g, filename = "plot_count_title", w = 1000, h = 800)
  g <- plotly(plot_count_description + ggtitle("Non-empty description length boxplots"), .15, w = 900, h = 700)
  api_create(g, filename = "plot_count_description")
  g <- plotly(description_missing_plot_facet, .15, w = 1000, h = 800)
  api_create(g, filename = "description_missing_plot_facet")
  g <- plotly(description_car_personal_plot, .12, w = 1000, h = 650)
  api_create(g, filename = "description_car_personal_plot")
  g <- plotly(title_car_personal_plot, .12, w = 1000, h = 650)
  api_create(g, filename = "title_car_personal_plot")
  g <- plotly(description_lawyer_attorney_plot, .12, w = 1000, h = 650)
  api_create(g, filename = "description_lawyer_attorney_plot")
  g <- plotly(title_lawyer_attorney_plot, .12, w = 1000, h = 650)
  api_create(g, filename = "title_lawyer_attorney_plot")
  g <- plotly(description_city_plot, .12, w = 1000, h = 650)
  api_create(g, filename = "description_city_plot")
  g <- plotly(title_city_plot, .12, w = 1000, h = 650)
...
if(save == T){ 
  ...
  # interactive chart pushed to plotly chart studio
  g <- plotly(rating_distribution_plot, .2, w = 1000, h = 750)
  api_create(g, filename = "rating_distribution_plot")
  g <- plotly(review_position_plot, .2, w = 1000, h = 750)
  api_create(g, filename = "review_position_plot")
  g <- plotly(rating_position_plot, .2, w = 1000, h = 750)
...
if(save == T){ 
  ...
  # interactive chart pushed to plotly chart studio
  g <- plotly(ref_domains_dofollow_plot, .2, w = 1000, h = 750)
  api_create(g, filenmae = "ref_domains_dofollow_plot")
  g <- plotly(total_traffic_plot, .2, w = 1000, h = 750)
  api_create(g, filename = "total_traffic_plot")
  g <- plotly(ahrefs_rank_plot, .2, w = 1000, h = 750)
  api_create(g, filename = "ahrefs_rank_plot")
  g <- plotly(domain_rating_plot, .2, w = 1000, h = 750)
...
if(save == T){ 
  ...
  # interactive chart pushed to plotly chart studio
  g <- plotly(number_of_photos_plot, .2, w = 1000, h = 750)
  api_create(g, filename = "number_of_photos_plot")
  g <- plotly(provides_updates_plot_facet, .2, w = 1000, h = 750)
