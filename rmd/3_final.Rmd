...
Some of the variables included in the model can be considered to be control variables. I.e. they are not itself interest of the analysis, but have to be included to get more accurate view of impact of other factors, for example place population.